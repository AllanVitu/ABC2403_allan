...
public class App {
	...
	public static String getFullName(String prenom, String nom) {
		...
		String nameFull = prenom + " " + nom.toUpperCase();
	...
	public static String askUser(String nom, String prenom) {
		...
		String hello = App.getFullName(prenom, nom);
		
		String hiEvryOne = App.getMC2();
		
		return "Bonjour " + hello + " Connaissez-vous " + hiEvryOne + "?";
